            ...
            child: Column(
              ...
              children: [
                ...
                const Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    CustomText( requiredText: 'To-do Added', fontWeight: FontWeight.bold, fontSize: 32,
                      color: Colors.black,
                    ),
                    SizedBox(height: 8),
                    CustomText( requiredText: 'Successfully', fontWeight: FontWeight.w500, fontSize: 23,
                      color: Colors.black,
                    ),
                  ],
                ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  CustomText( requiredText: 'Close', fontSize: 16,
                    color: Colors.white,
                  ),
                ],
              ),
